        ...
        <section>
            <div className="row mt-3 bg-secondary bg-opacity-10 pt-3">
                <div className="col-lg-3 px-5">
                    ...
                    <div className="fs-2">
                        <a href="https://api.github.com/users/github-john-doe" target="blank"><i class="fa-brands fa-github text-dark"></i></a>
                        <a href="https://twitter.com/home" target="blank"><i class="fa-brands fa-square-twitter text-dark"></i></a>
                        <a href="https://www.linkedin.com/feed/" target="blank"><i class="fa-brands fa-linkedin text-dark"></i></a>
                    </div>
                </div>
            ...
            <div className="d-flex justify-content-center bg-dark p-2 ">
                <i class="fa-regular fa-copyright text-bg-dark p-1"></i>
