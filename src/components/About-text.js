const AboutText = () => {
    return (
        <div className="col-lg-6 col-md-6 p-5">
            ...
            <p className="m-3">Basé à Lyon, je suis à la recherche d'une alternance au sein d'une agence digitale pour consolider ma formation de <strong>développeur web full stack</strong>.</p>
